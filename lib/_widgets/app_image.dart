...
class HostedImage extends StatelessWidget {
  const HostedImage(this.url, {Key key, this.fit = BoxFit.cover, this.height = 200, this.width = 140}) : super(key: key);
  final String url;
  final BoxFit fit;
  final double height;
  final double width;
  ...
  Widget build(BuildContext context) {
    ...
    return CachedNetworkImage(imageUrl: secureUrl, fit: fit,height: height, width: width);
  }
}
